...
class NavigationDrawer extends StatelessWidget {
  void dashboardPressed(BuildContext cxt) {
    BlocProvider.of<RedirectBloc>(cxt).dispatch(
      NavDashboard(),
    );
  }
  ...
  void logOutPressed(BuildContext cxt) {
    // AppInheritedWidget.of(cxt).authBloc.firebaseAuth.signOut().then((onValue) {
                  ...
                  children: [
                    ...
                    buildOption(
                        AppInheritedWidget.of(cxt)
                            .text('Dashboard', category: 'overview'),
                        () => dashboardPressed(cxt)),
                    buildOption(
                        AppInheritedWidget.of(cxt)
                            .text('Settings', category: 'overview'),
                        () => settingsPressed(cxt)),
                    Expanded(child: Container()),
                    buildOption(
                        AppInheritedWidget.of(cxt)
                            .text('LogOut', category: 'overview'), () {
                      BlocProvider.of<AuthenticationBloc>(cxt).dispatch(
                        LoggedOut(),
                      );
                    }),
